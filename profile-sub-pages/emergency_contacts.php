...
<script>
    (function($){
        ...
        if($_SESSION['loginUser'] == 'CT') {
            ...
            ?>
            $('#emergency_contacts input').attr('disabled', true);
            $('#emergency_contacts select').attr('disabled', true);
            $('#emergency_contacts textarea').attr('disabled', true);
            ...
            $(document).on('click', '.emergency-contact-view-btn', function() {
                var tr = $(this).parents('tr');

                $($modal_emergency_contacts).addClass('view');
